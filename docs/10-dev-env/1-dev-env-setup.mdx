...
Navigate to the Instruqt lab using [this link](http://mdb.link/instruqt-rm).

Fill out the form that appears and click **Submit and access**.

<Screenshot url="https://play.instruqt.com" src="img/10-dev-env/2-submit-form.png" alt="Submit Instruqt form" />

Click **Start** to launch the lab environment.

<Screenshot url="https://play.instruqt.com" src="img/10-dev-env/3-start-sandbox-setup.png" alt="Start Instruqt sandbox" />
...
<Screenshot url="https://play.instruqt.com" src="img/10-dev-env/4-start-lab.png" alt="Start Instruqt lab" />
...
:::caution
 During the lab, we will use Instruqt or GitHub Codespaces. The following instructions are here just in case you can't use either or if you really, really, really want a local installation.
:::
...
<details>
  ...
  :::info
  Again: during the lab, we will use Instruqt or GitHub Codespaces. The following instructions are here just in case you can't use Instruqt or Codespaces or if you really, really, really want to try a local installation.
  :::
