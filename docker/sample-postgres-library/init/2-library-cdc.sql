...
ALTER TABLE "library"."operations" OWNER TO REPLICATION_GROUP;
...
CREATE PUBLICATION "migrator_postgres_publication" FOR TABLE "library"."author_alias", "library"."users", "library"."author_book", "library"."authors", "library"."books", "library"."book_attribute", "library"."operations", "library"."reviews", "library"."book_genre";
...
*/
        ...
        ALTER TABLE "library"."operations" REPLICA IDENTITY FULL;
